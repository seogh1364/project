const COURSE_DATA = [
    {
        ...
        maxPrice: 40000,
        title: '성산 산책',
        description: '마포 성산동에서 가볍게 즐기는 산책 코스',
        duration: '약 2시간',
        transport: '도보 위주',
        mapArea: '마포 성산',
        guideImage: 'course-img/성산.png',
        places: [
            { icon: '🍗', name: '베이직 프라이드 치킨', mapName: '베이직프라이드치킨 마포성산', priceText: '26,000원' },
            { icon: '☕', name: '베케이션 카페', mapName: '베케이션카페 마포', priceText: '10,000원' },
            { icon: '🌳', name: '성산 산책', mapName: '마포구 성산동', priceText: '0원' }
        ]
    },
    {
        id: 'hongjecheon-walk',
    ...
    },
    {
        ...
        places: [
            { icon: '🛍️', name: '제로스페이스', mapName: '제로스페이스 망원', priceText: '0원', description: '문구류와 포스터를 가볍게 구경하는 시작 코스입니다.' },
            { icon: '☕', name: '딥블루레이크', mapName: '딥블루레이크 망원', priceText: '12,000~16,000원', description: '음료를 마시며 차분하게 대화하기 좋은 카페 코스입니다.' },
            { icon: '🥟', name: '망원시장 먹거리', mapName: '망원시장', priceText: '15,000~22,000원', description: '간식 2~3개를 나눠 먹으며 예산을 맞추기 좋은 코스입니다.' },
            { icon: '📷', name: '망원동 네컷사진', mapName: '망원동 네컷사진', priceText: '5,000~8,000원', description: '마지막에 사진으로 추억을 남기는 선택 코스입니다.' },
            { icon: '🌿', name: '망리단길 산책', mapName: '망리단길', priceText: '0원', description: '소품샵과 골목을 천천히 걷는 무료 마무리 코스입니다.' }
        ]
    },
    {
        ...
        places: [
            { icon: '📚', name: '가가77페이지', mapName: '가가77페이지 망원', priceText: '0원', description: '독립출판물과 엽서류를 조용히 둘러보기 좋은 서점 코스입니다.' },
            { icon: '🍱', name: '헤키 망원', mapName: '헤키 망원', priceText: '31,000~36,000원', description: '돈카츠 정식 중심으로 든든하게 식사하는 코스입니다.' },
            { icon: '🍵', name: '티노마드', mapName: '티노마드 망원', priceText: '18,000~22,000원', description: '차와 디저트로 오래 앉아 이야기하기 좋은 티룸 코스입니다.' },
            { icon: '🌿', name: '포은로 산책', mapName: '포은로 망원', priceText: '0원', description: '망원2동 쪽으로 빠지지 않는 짧은 산책 마무리입니다.' }
        ]
    },
    {
    ...
    },
    {
        ...
        places: [
            ...
            { icon: '🌿', name: '경의선 숲길', mapName: '경의선숲길 연남동', priceText: '산책', description: '식사 후 연트럴파크 중심부를 따라 천천히 걷는 산책 코스입니다.' },
            { icon: '🎁', name: '소품샵 구경', mapName: '연남동 소품샵거리', priceText: '구경', description: '숲길 주변의 아기자기한 가게를 둘러보며 가볍게 쉬어가는 코스입니다.' },
    ...
    },
    {
        ...
        places: [
            ...
            { icon: '🏘️', name: '연남동 골목 산책', mapName: '연남동 골목길', priceText: '산책', description: '주택가 골목과 작은 가게들을 구경하며 카페로 이동하는 코스입니다.' },
    ...
    },
    {
        ...
        places: [
            { icon: '🎨', name: 'KT&G 상상마당', mapName: 'KT&G 상상마당 홍대', priceText: '0원', description: '디자인 소품과 아이디어 상품을 둘러보며 대화를 시작하기 좋은 코스입니다.' },
            { icon: '🍜', name: '칸다소바 홍대점', mapName: '칸다소바 홍대점', priceText: '22,000원', description: '마제소바로 든든하게 식사하며 예산을 맞추기 좋은 코스입니다.' },
            { icon: '☕', name: '테일러커피 서교점', mapName: '테일러커피 서교점', priceText: '14,000원', description: '시그니처 커피를 마시며 여유롭게 쉬어가는 카페 코스입니다.' },
            { icon: '📷', name: '인근 네컷 사진관', mapName: '홍대 네컷사진', priceText: '5,000원', description: '홍대 거리에서 가볍게 사진을 남기며 마무리하는 추억 코스입니다.' }
        ]
    },
    {
        id: 'seogyo-5-6',
        ...
        places: [
            { icon: '🛍️', name: '오브젝트 서교점', mapName: '오브젝트 서교점', priceText: '0원', description: '감성적인 문구와 생활 소품을 여유롭게 구경하는 편집샵 코스입니다.' },
            { icon: '🍕', name: '피자네버슬립스', mapName: '피자네버슬립스 홍대', priceText: '35,000원', description: '캐주얼한 분위기에서 피자를 나눠 먹는 든든한 식사 코스입니다.' },
            { icon: '🍸', name: '자세(JASE)', mapName: '자세 JASE 홍대', priceText: '25,000원', description: '은은한 조명 아래 가벼운 칵테일로 대화하기 좋은 마무리 코스입니다.' }
        ]
    }
];
